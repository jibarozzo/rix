# This file was generated by the {rix} R package v0.15.0 on 2025-02-14
# with following call:
# >rix(date = "2025-01-27",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "3b532cf0875ef5505463b33920d785dfe562b608"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-01-27.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "3b532cf0875ef5505463b33920d785dfe562b608";
        sha256 = "sha256-gZqWSlRv8TMWUGP1pvA5GF28g5GA+Qbfw2mQrIPhVV8=";
      };
